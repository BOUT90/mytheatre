<%-- 
    Document   : monCompteProducteur
    Created on : 10 mars 2017, 09:55:58
    Author     : niangd
--%>
...
<html>
    <head>
        <title>Bienvenue sur Mytheâtre</title>
        <meta charset="UTF-8">
            ...
            <div class="detailPage">
                <div class="formulaireCentre"  >
                    ...
                    <div id="listeInfoCompte">
                        ...
                        <label>E-mail : </label><span style="font-weight: lighter;"><%=user.getMail()%></span><br>
                    ...
                    <div>
                        <a href="/Mytheatre/ProdPropoSpecGestionCompte?choix=proposerspectacle">Proposer Spectacle </a> <br>
                    </div>
                    <div>
                        <a href="/Mytheatre/ProdPropoSpecGestionCompte?choix=changermotdepasse">Changement de mot de passe</a> <br>  
                    </div>
                    <div>
                        <a href="/Mytheatre/ProdPropoSpecGestionCompte?choix=ChangementInfos" >Changement informations</a> <br> <br> <br> 
                    </div>
