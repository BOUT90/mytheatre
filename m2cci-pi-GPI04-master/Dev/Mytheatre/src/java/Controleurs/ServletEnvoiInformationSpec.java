...
import Modeles.InfoSpectaclePDF;
 ...
 *
 */
@WebServlet(name = "ServletEnvoiInformationSpec", urlPatterns = {"/sendInfoSpec"})

public class ServletEnvoiInformationSpec extends HttpServlet {
...
//    private Session mailSession;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            SpectacleDate spectacle = (SpectacleDate) request.getSession().getAttribute("spectacle");
            List<Integer> listePlacesDispo = (ArrayList<Integer>) request.getSession().getAttribute("listePlaces");
...
//            int prixTotal = (Integer) request.getSession().getAttribute("prixTotal");
            ...
            byte[] pdfTicket = InfoSpectaclePDF.createPDF_AsByteArray(spectacle, listePlacesDispo);
            ...
            // création du message
            String messageBody = "Merci d'utiliser MyThêatre\n"
                    + "voici en document attaché les informations demandées";
            ...
            Logger.getLogger(ServletEnvoiInformationSpec.class.getName()).log(Level.SEVERE, null, ex);
        }
        try (PrintWriter out = response.getWriter()) {
