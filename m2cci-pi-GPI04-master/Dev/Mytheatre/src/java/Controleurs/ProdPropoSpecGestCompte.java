 ...
 * @author niangd
 */
@WebServlet(name = "PropositionGestionProd", urlPatterns = {"/ProdPropoSpecGestionCompte"})
public class ProdPropoSpecGestCompte extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (choix) {
            case "proposerspectacle":
                //request.setAttribute("changementInfo", changementInfos);
            ...
            //case "changerinformations":
              case "ChangementInfos":
                ...
                try {
                    ...
                    session.setAttribute("adresse", Utilisateur.getMail());
