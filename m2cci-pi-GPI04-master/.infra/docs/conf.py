...
CONTRIBUTORS_FILE = os.path.join(PROJECT_DIR,'CONTRIBUTORS.rst')
...
project = PROJECT_NAME + group

copyright = u'2017, (CC)(SA)(BY) UFRIMAG'
author = u'M2CCI'
version = 'GPI 0.1'
release = '0.1'
...
exclude_patterns = [
    ...
    'CONTRIBUTORS.rst',
    'CREDITS.rst',
    # '.infra/docs/problems/index.rst',
    'References/Glossaire*.rst',
    '**/.build/*.generated.rst',
    ]
default_role = 'any'
show_authors = False
